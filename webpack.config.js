...
// 	cwd: srcDir,
// }).map((key) => {
// 	entries['js/' + key] = path.resolve(srcDir, key);
// });

entries['js//blocks/index.js'] = path.resolve(srcDir, 'blocks/index.js');
entries['js/admin.js'] = path.resolve(srcDir, 'admin.js');
...
module.exports = {
	...
	resolve: {
		alias: {
			...
			'@wp': path.resolve(__dirname, 'src/js/blocks/inc/wp.js'),
		},
	},
};
