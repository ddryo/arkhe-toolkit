...
\Arkhe_Toolkit::add_menu_section( [
	...
	'page_name'  => $page_name,
	'db'         => $db_name,
	'page_cb'    => '\Arkhe_Toolkit\Menu\cb_head_code',
] );

function cb_head_code( $args ) {
...
\Arkhe_Toolkit::add_menu_section( [
	...
	'page_name'  => $page_name,
	'db'         => $db_name,
	'page_cb'    => '\Arkhe_Toolkit\Menu\cb_body_code',
] );

function cb_body_code( $args ) {
	\Arkhe_Toolkit::output_textarea([
		'db'      => $args['db'],
		'key'     => $args['section_key'],
		'rows'    => '6',
...
\Arkhe_Toolkit::add_menu_section( [
	...
	'page_name'  => $page_name,
	'db'         => $db_name,
	'page_cb'    => '\Arkhe_Toolkit\Menu\cb_foot_code',
] );

function cb_foot_code( $args ) {
	\Arkhe_Toolkit::output_textarea([
		'db'      => $args['db'],
		'key'     => $args['section_key'],
		'rows'    => '6',
